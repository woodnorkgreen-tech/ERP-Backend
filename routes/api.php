...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('projects')->group(function () {
        ...
        // Universal Task integration routes
        Route::get('projects/{projectId}/universal-tasks', [TaskController::class, 'getProjectUniversalTasks']);
        Route::post('projects/{projectId}/universal-tasks', [TaskController::class, 'createProjectUniversalTask']);
        Route::get('universal-tasks/department', [TaskController::class, 'getDepartmentUniversalTasks']);

        // Universal Task module routes (integrated access from Projects)
        Route::prefix('universal-tasks')->group(function () {
            Route::get('/', [App\Modules\UniversalTask\Controllers\TaskController::class, 'index']);
            Route::post('/', [App\Modules\UniversalTask\Controllers\TaskController::class, 'store']);
            Route::get('/{task}', [App\Modules\UniversalTask\Controllers\TaskController::class, 'show']);
            Route::put('/{task}', [App\Modules\UniversalTask\Controllers\TaskController::class, 'update']);
            Route::delete('/{task}', [App\Modules\UniversalTask\Controllers\TaskController::class, 'destroy']);
            Route::put('/{task}/status', [App\Modules\UniversalTask\Controllers\TaskController::class, 'updateStatus']);
            Route::post('/{task}/assign', [App\Modules\UniversalTask\Controllers\TaskController::class, 'assign']);

            // Comments
            Route::get('/{task}/comments', [App\Modules\UniversalTask\Controllers\TaskCommentController::class, 'index']);
            Route::post('/{task}/comments', [App\Modules\UniversalTask\Controllers\TaskCommentController::class, 'store']);
            Route::put('/{task}/comments/{comment}', [App\Modules\UniversalTask\Controllers\TaskCommentController::class, 'update']);
            Route::delete('/{task}/comments/{comment}', [App\Modules\UniversalTask\Controllers\TaskCommentController::class, 'destroy']);
            Route::post('/{task}/comments/{comment}/reply', [App\Modules\UniversalTask\Controllers\TaskCommentController::class, 'reply']);

            // Attachments
            Route::get('/{task}/attachments', [App\Modules\UniversalTask\Controllers\TaskAttachmentController::class, 'index']);
            Route::post('/{task}/attachments', [App\Modules\UniversalTask\Controllers\TaskAttachmentController::class, 'store']);
            Route::get('/{task}/attachments/{attachment}', [App\Modules\UniversalTask\Controllers\TaskAttachmentController::class, 'show']);
            Route::get('/{task}/attachments/{attachment}/download', [App\Modules\UniversalTask\Controllers\TaskAttachmentController::class, 'download']);
            Route::delete('/{task}/attachments/{attachment}', [App\Modules\UniversalTask\Controllers\TaskAttachmentController::class, 'destroy']);
            Route::get('/{task}/attachments/{filename}/versions', [App\Modules\UniversalTask\Controllers\TaskAttachmentController::class, 'getVersions']);

            // Issues
            Route::get('/{task}/issues', [App\Modules\UniversalTask\Controllers\TaskIssueController::class, 'index']);
            Route::post('/{task}/issues', [App\Modules\UniversalTask\Controllers\TaskIssueController::class, 'store']);
            Route::get('/{task}/issues/{issue}', [App\Modules\UniversalTask\Controllers\TaskIssueController::class, 'show']);
            Route::put('/{task}/issues/{issue}', [App\Modules\UniversalTask\Controllers\TaskIssueController::class, 'update']);
            Route::post('/{task}/issues/{issue}/resolve', [App\Modules\UniversalTask\Controllers\TaskIssueController::class, 'resolve']);
            Route::get('/issues/search', [App\Modules\UniversalTask\Controllers\TaskIssueController::class, 'search']);

            // Experience Logs
            Route::get('/{task}/experience-logs', [App\Modules\UniversalTask\Controllers\TaskExperienceController::class, 'index']);
            Route::post('/{task}/experience-logs', [App\Modules\UniversalTask\Controllers\TaskExperienceController::class, 'store']);
            Route::get('/{task}/experience-logs/{log}', [App\Modules\UniversalTask\Controllers\TaskExperienceController::class, 'show']);
            Route::put('/{task}/experience-logs/{log}', [App\Modules\UniversalTask\Controllers\TaskExperienceController::class, 'update']);
            Route::delete('/{task}/experience-logs/{log}', [App\Modules\UniversalTask\Controllers\TaskExperienceController::class, 'destroy']);
            Route::get('/experience-logs/search', [App\Modules\UniversalTask\Controllers\TaskExperienceController::class, 'search']);

            // Templates
            Route::get('/templates', [App\Modules\UniversalTask\Controllers\TaskTemplateController::class, 'index']);
            Route::post('/templates', [App\Modules\UniversalTask\Controllers\TaskTemplateController::class, 'store']);
            Route::get('/templates/{template}', [App\Modules\UniversalTask\Controllers\TaskTemplateController::class, 'show']);
            Route::put('/templates/{template}', [App\Modules\UniversalTask\Controllers\TaskTemplateController::class, 'update']);
            Route::delete('/templates/{template}', [App\Modules\UniversalTask\Controllers\TaskTemplateController::class, 'destroy']);
            Route::post('/templates/{template}/instantiate', [App\Modules\UniversalTask\Controllers\TaskTemplateController::class, 'instantiate']);
            Route::get('/templates/{template}/versions', [App\Modules\UniversalTask\Controllers\TaskTemplateController::class, 'getVersions']);

            // Analytics
            Route::get('/analytics/dashboard', [App\Modules\UniversalTask\Controllers\TaskAnalyticsController::class, 'getDashboard']);
            Route::get('/analytics/metrics', [App\Modules\UniversalTask\Controllers\TaskAnalyticsController::class, 'getKeyMetrics']);
            Route::get('/analytics/time-series', [App\Modules\UniversalTask\Controllers\TaskAnalyticsController::class, 'getTimeSeries']);
            Route::get('/analytics/department', [App\Modules\UniversalTask\Controllers\TaskAnalyticsController::class, 'getDepartmentAnalytics']);
            Route::post('/analytics/export', [App\Modules\UniversalTask\Controllers\TaskAnalyticsController::class, 'export']);

            // Subtasks
            Route::get('/{task}/subtasks', [App\Modules\UniversalTask\Controllers\SubtaskController::class, 'index']);
            Route::post('/{task}/subtasks', [App\Modules\UniversalTask\Controllers\SubtaskController::class, 'store']);
            Route::get('/subtasks/{subtask}', [App\Modules\UniversalTask\Controllers\SubtaskController::class, 'show']);
            Route::put('/subtasks/{subtask}', [App\Modules\UniversalTask\Controllers\SubtaskController::class, 'update']);
            Route::delete('/subtasks/{subtask}', [App\Modules\UniversalTask\Controllers\SubtaskController::class, 'destroy']);
            Route::get('/{task}/subtasks/hierarchy', [App\Modules\UniversalTask\Controllers\SubtaskController::class, 'getHierarchy']);

            // History and Activity
            Route::get('/{task}/history', [App\Modules\UniversalTask\Controllers\TaskController::class, 'getHistory']);
            Route::get('/{task}/activity', [App\Modules\UniversalTask\Controllers\TaskController::class, 'getActivity']);
        });
    ...
    Route::prefix('finance')->group(function () {
        ...
        // Universal Task integration for Finance department
        Route::get('universal-tasks', function () {
            // Get Universal Tasks for Finance department
            $user = auth()->user();
            $tasks = \App\Modules\UniversalTask\Models\Task::where('department_id', $user->department_id)
            ...
            return response()->json([
                'data' => $tasks,
                'message' => 'Finance department Universal Tasks retrieved successfully'
            ]);
        });
    });

    // Universal Task integration for other departments
    Route::prefix('universal-tasks')->group(function () {
        // Department-specific access
        Route::get('my-department', function () {
            $user = auth()->user();
            $tasks = \App\Modules\UniversalTask\Models\Task::where('department_id', $user->department_id)
                ->with(['assignedUser', 'creator', 'taskable'])
                ->orderBy('created_at', 'desc')
                ->paginate(15);
        ...
        // Quick task creation for current department
        Route::post('quick-create', function (Request $request) {
            $user = auth()->user();
            ...
            $task = \App\Modules\UniversalTask\Models\Task::create([
                'title' => $request->title,
