...
class FundCustodyServiceTest extends TestCase
{
    ...
    private function payment(User $user, PettyCashTopUp $topUp, float $amount, string $status, bool $archived = false): Payment
    {
        return Payment::create([
            'top_up_id' => $topUp->id, 'payee_name' => 'Recipient', 'account' => 'Expense', 'amount' => $amount,
