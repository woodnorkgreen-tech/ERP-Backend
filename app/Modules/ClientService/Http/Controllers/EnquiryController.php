...
class EnquiryController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'status' => 'required|string|in:client_registered,enquiry_logged,site_survey_completed,design_completed,design_approved,materials_specified,budget_created,quote_prepared,quote_approved,planning,in_progress,completed,closed,cancelled',
    ...
    public function update(Request $request, ProjectEnquiry $enquiry): JsonResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'status' => 'sometimes|required|string|in:client_registered,enquiry_logged,site_survey_completed,design_completed,design_approved,materials_specified,budget_created,quote_prepared,quote_approved,planning,in_progress,completed,closed,cancelled',
            'department_id' => 'nullable|integer|exists:departments,id',
            'assigned_department' => 'nullable|string|max:255',
            'project_deliverables' => 'nullable|string',
            'assigned_po' => 'nullable|integer|exists:users,id',
