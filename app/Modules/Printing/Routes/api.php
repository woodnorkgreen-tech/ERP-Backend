...
use App\Modules\Printing\Controllers\PrintIntakeController;
...
Route::get('/intake', [PrintIntakeController::class, 'index']);
Route::post('/intake/{handoff}/accept', [PrintIntakeController::class, 'accept']);
Route::post('/intake/{handoff}/reject', [PrintIntakeController::class, 'reject']);
