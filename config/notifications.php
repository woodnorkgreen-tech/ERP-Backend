...
return [
    ...
    'types' => [
        ...
        'offboarding_settlement_calculated' => [
            ...
            'default_channels' => ['database', 'mail', 'push'], 'urgency' => 'warning',
        ],
        'offboarding_settlement_approved' => [
            'module' => 'hr', 'label' => 'Final Settlement Approved',
            'default_channels' => ['database', 'push'], 'urgency' => 'success',
        ],
        ...
        'grievance_resolved' => [
            ...
            'default_channels' => ['database', 'mail', 'push'], 'urgency' => 'success',
        ],
        'grievance_escalated' => [
        ...
        'incident_status_changed' => [
            ...
            'default_channels' => ['database', 'mail', 'push'], 'urgency' => 'info',
        ],
